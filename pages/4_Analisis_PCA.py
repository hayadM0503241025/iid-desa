...
def resolve_default_request() -> dict[str, Any]:
    ...
    if "dashboard_request" in st.session_state:
        ...
        return {
            "mode": "olah_ulang",
            "input_path": request.get("input_path", str(detect_default_input_path() or BASE_DIR / "data_asli.csv")),
...
def render_sidebar() -> dict[str, Any]:
    ...
    default_input = detect_default_input_path() or BASE_DIR / "data_asli.csv"
